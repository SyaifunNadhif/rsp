...
<div class="h-[80vh] flex items-center">
    ...
    <div class="register w-1/4 mx-auto">
        <h1 class="text-xl font-bold mb-5">Register Admin</h1>
        ...
        <form method="POST" action="index.php?page=registerUser">
            ...
            <div class="flex flex-col gap-5">
                ...
                <button type="submit" class="bg-indigo-600 hover:bg-indigo-700 text-white w-full rounded-lg py-2">Register Now</button>
            </div>
        </form>
    </div>
</div>